...
$(document).ready(function(){
    ...
    /* Executes after data is loaded and rendered */
	    ...
	    {
	        $(".actormodal").modal();
	        $.post("getActorInfo",{id:$(this).data("row-id")},function(data){
	        	$("#fname").val(data.actor.first_name);
	        	$("#lname").val(data.actor.last_name);
	        	$("#lupdate").val(data.actor.last_update);
	        	$("#actorid").val(data.actor.id);
	        });
	    });
  	});
  });
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="form-group">
    		...
    		<input type="text" name="actor.first_name" class="form-control" id="fname">
  		</div>
        <div class="form-group">
    		<label for="lname">last name</label>
    		<input type="text" name="actor.last_name" class="form-control" id="lname">
  		</div>
  		<div class="form-group">
    		<label for="lupdate">last update</label>
    		<input type="text" name="actor.last_update" class="form-control" id="lupdate">
